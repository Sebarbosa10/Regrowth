...
public class GunRecoil : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        gunModel.localPosition = Vector3.Lerp(gunModel.localPosition, targetPosition, speed);
        gunModel.localRotation = Quaternion.Slerp(gunModel.localRotation, targetRotation, speed);
